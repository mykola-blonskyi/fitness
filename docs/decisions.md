...
Measured over five seeds and 300 menus per meal count, both pools: the calorie ceiling, the no-repeat rule and the protein-Family cap are unchanged, and no salad in 108,000 held fewer than two bulk items. On the moderate profile the three mean absolute macro deltas cost at most 0.76 g in total, at five meals. On ADR-019's extreme 310P profile, which already misses carbs by 42-52 g because its protein target is unreachable, they cost 0.78 to 4.16 g: a plan with no headroom cannot absorb the ~65 g of vegetable the accent slot removes from each meal. See `reports/audits/2026-09-13-salad-composition.md`.
